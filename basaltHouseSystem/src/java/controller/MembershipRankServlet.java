...
public class MembershipRankServlet extends HttpServlet {
   private static final AuthService auth = new AuthService();
    ...
    throws ServletException, IOException {
        ...
        CustomerMembershipDAO dao = new CustomerMembershipDAO();
        CustomerRanking cr = dao.getCustomeRankingById(user.getAccountId());
        List<MembershipRank>list = dao.getRankName();
