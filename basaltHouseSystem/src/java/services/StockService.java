...
public class StockService {
    ...
    public HashMap<String, HashMap<String, Integer>> calculateProduct() {
        ...
        HashMap<Integer, String> productMap = p.getProduct();
        ...
        for (Map.Entry<Integer, HashMap<Integer, List<Recipe>>> entry
                : recipeMap.entrySet()) {
    ...
    public boolean updateStockQuantity(int productId, int sizeId, int quantity) {
        RecipeDAO r = new RecipeDAO();
        IngredientDAO i = new IngredientDAO();
        HashMap<Integer, HashMap<Integer, List<Recipe>>> recipeMap = r.getRecipeMap();
        ...
        for (Recipe recipe : recipes) {
            ...
            BigDecimal quantityNeed
                    = recipe.getQuantityNeeded()
