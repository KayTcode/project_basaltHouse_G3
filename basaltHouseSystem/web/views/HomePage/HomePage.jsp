...
<%
    ...
    if (_userObj != null) {
        ...
        String _fn = _u.getFullName();
        if (_fn != null && !_fn.trim().isEmpty()) {
            String[] _parts = _fn.trim().split("\\s+");
            if (_parts.length >= 2) {
                _initials = String.valueOf(_parts[0].charAt(0)).toUpperCase()
                          + String.valueOf(_parts[_parts.length - 1].charAt(0)).toUpperCase();
            } else {
                _initials = _fn.substring(0, Math.min(2, _fn.length())).toUpperCase();
            }
        }
    }
...
<html lang="vi">
    <head>
        ...
        <title>BasaltHouse - Good Coffee, Good Mood</title>
        <!-- Bootstrap 5 CSS -->
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="coffeelyNav">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            <button class="btn-nav-icon" title="Tìm kiếm" aria-lable="Tìm kiếm">
                                        ...
                                        <div class="user-dropdown"
                                            ...
                                            <c:choose>
                                                ...
                                                <c:otherwise>
                                                    ...
                                                    <a href="${pageContext.request.contextPath}/customer/settings"
                                                       class="dropdown-item-link" role="menuitem">
