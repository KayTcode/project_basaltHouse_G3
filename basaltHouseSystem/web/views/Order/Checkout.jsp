...
<head>
    ...
    <link href="${pageContext.request.contextPath}/css/CartCss/Cart.css?v=3" rel="stylesheet">
    <link href="${pageContext.request.contextPath}/css/CartCss/Checkout.css?v=3" rel="stylesheet">
