                ...
                <%@taglib prefix="fn" uri="jakarta.tags.functions" %>
                    ...
                    <head>
                        ...
                        <link
                            ...
                            rel="stylesheet">
                        <link href="${pageContext.request.contextPath}/css/CartCss/Cart.css?v=20260709-1"
                            rel="stylesheet">
                        <link href="${pageContext.request.contextPath}/css/CartCss/Checkout.css?v=20260709-1"
                            rel="stylesheet">
                        <link href="${pageContext.request.contextPath}/css/Customer/CustomerTheme.css?v=20260709-1"
                            rel="stylesheet">
                        <link rel="stylesheet"
                            ...
                            <div class="co-page">
                                <div class="container">
                                    ...
                                    <form action="${pageContext.request.contextPath}/Cart" method="POST"
                                        id="checkoutForm" onsubmit="return validateForm()">
                                                    ...
                                                    <div class="co-body">
                                                        ...
                                                        <div class="co-zone">
                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="co-zone-desc">Chúng tôi chỉ giao hàng trong
                                                                    khu vực — Vui lòng nhập địa chỉ trong phạm vi phục
                                                                    vụ của chúng tôi.</div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="co-grid">
                                                            <div class="co-field full">
                                                                <label>Họ và tên người nhận <span
                                                            ...
                                                            <div class="co-field full">
                                                                <label>Số nhà / Tên đường <span
                                                                        class="req">*</span></label>
                                                                <input type="text" name="street" id="street"
                                                                    placeholder="VD: Khu A FPT, Đường số 3..."
                                                                    autocomplete="street-address">
                                                            </div>
                                                            <div class="co-field full">
                                                                <label>Khu vực (Hòa Lạc) <span
                                                                        class="req">*</span></label>
                                                                <select name="district" id="district" class="co-select">
                                                                    <option value=""> Chọn khu vực </option>
                                                                    <c:forEach var="zone" items="${activeZones}">
                                                                        <option
                                                                            value="${zone.wardName}, ${zone.district}, ${zone.province}">
                                                                            ${zone.wardName}, ${zone.district},
                                                                            ${zone.province}
                                                                        </option>
                                                                    </c:forEach>
                                                                </select>
                                                            ...
                                                            <div class="co-field full">
                                                                ...
                                                                <input type="text" name="deliveryNote" id="deliveryNote"
                                                                    placeholder="Gọi trước khi đến, giao giờ hành chính...">
                                                            </div>
                                                        </div>

                                                        <div class="co-error" id="formError">
                                                            <span class="material-symbols-outlined">error</span>
                                                            Vui lòng điền đầy đủ họ tên, số điện thoại, số nhà và
                                                            phường/quận.
                                                        </div>
                                                        ...
                                                        <div class="cart-page-panel payment-section"
                                                            style="margin-top: 0; border: none; padding: 0; background: transparent; box-shadow: none;">
                                                            <%-- Option 1: COD --%>
                                                                <div class="payment-option mb-3">
                                                                    <input type="radio" name="paymentMethod"
                                                                        id="pay_cod" value="COD" checked>
                                                                    <label class="payment-option-label" for="pay_cod">
                                                                        <div class="payment-icon"
                                                                            style="background:#e8f5e9;">
                                                                            <i class="bi bi-cash-coin fs-5"
                                                                                style="color:#005c25;"></i>
                                                                        </div>
                                                                        <div>
                                                                            <div
                                                                                style="font-weight:600;font-size:14px;color:#1a1a1a;">
                                                                                Tiền mặt khi nhận hàng</div>
                                                                            <div
                                                                                style="font-size:12px;color:#6b7280;margin-top:2px;">
                                                                                COD — Thanh toán khi shipper giao</div>
                                                                        </div>
                                                                    </label>
                                                                </div>
                                                                    ...
                                                                    <div class="payment-option">
                                                                        ...
                                                                        <label class="payment-option-label"
                                                                            ...
                                                                            <div>
                                                                                ...
                                                                                <div
                                                                                    style="font-size:12px;color:#6b7280;margin-top:2px;">
                                                                                    Quét QR hoặc chọn ngân hàng trên
                                                                                    MoMo</div>
                                                                            </div>
                                                                        </label>
                                                                    </div>
                                                ...
                                                <div class="co-summary-card">
                                                    ...
                                                    <c:if test="${not empty memberTier}">
                                                        <div class="co-member-badge-container">
                                                            <span
                                                                class="material-symbols-outlined member-icon">stars</span>
                                                            <span class="member-text">
                                                                Thành viên: <span class="badge">${memberTier}</span>
                                                                <c:if test="${memberDiscountPercent > 0}">
                                                                    (Ưu đãi giảm
                                                                    <fmt:formatNumber value="${memberDiscountPercent}"
                                                                        pattern="0.#" />%)
                                                                </c:if>
                                                            </span>
                                                        </div>
                                                                    ...
                                                                    <div class="co-summary-item-info">
                                                                        ...
                                                                        <div class="co-summary-item-meta">
                                                                            <c:if test="${not empty item.sizeName}">
                                                                                <span class="co-summary-item-size">Size
                                                                                    ${item.sizeName}</span>
                                                                            </c:if>
                                                                            <span
                                                                                class="co-summary-item-qty">x${item.quantity}</span>
                                                                        </div>
                                                                    </div>
                                                        ...
                                                        <div class="co-summary-pricing">
                                                            ...
                                                            <c:if test="${memberDiscountAmount > 0}">
                                                                <div class="co-pricing-row discount member-disc">
                                                                    <span class="co-pricing-row-label-with-icon">
                                                                        <span
                                                                            class="material-symbols-outlined">stars</span>
                                                                        Ưu đãi hội viên (${memberTier})
                                                                    </span>
                                                                    <span>-
                                                                        <fmt:formatNumber
                                                                            value="${memberDiscountAmount}"
                                                                            pattern="#,###" />₫
                                                                    </span>
                                                                </div>
                                                            </c:if>
                                                            <c:if test="${couponDiscountAmount > 0}">
                                                                <div class="co-pricing-row discount">
                                                                    <span class="co-pricing-row-label-with-icon">
                                                                        <span
                                                                            class="material-symbols-outlined">sell</span>
                                                                        Voucher giảm giá
                                                                    </span>
                                                                    <span>-
                                                                        <fmt:formatNumber
