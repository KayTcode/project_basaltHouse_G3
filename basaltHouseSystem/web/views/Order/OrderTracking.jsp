                        ...
                        <%-- Shared Header --%>
                            ...
                            <%-- ── Page Header (same pattern as Cart.jsp) ── --%>
                                ...
                                <%-- ── Main Content ── --%>
                                                            ...
                                                            <%-- Toast thông báo hủy đơn từ server --%>
                                                                ...
                                                                <%-- Filter Tabs --%>
                                                                    <div class="ot-filter-bar">
                                                                        <div class="ot-filter-tab active"
                                                                            data-filter="all"
                                                                            onclick="filterOrders(this,'all')">
                                                                            Tất cả
                                                                            <span
                                                                                class="ot-filter-count">${totalOrders}</span>
                                                                        </div>
                                                                        <div class="ot-filter-tab"
                                                                            data-filter="preparing"
                                                                            onclick="filterOrders(this,'preparing')">
                                                                            <span
                                                                                class="material-symbols-outlined">coffee_maker</span>
                                                                            Đang pha chế
                                                                        </div>
                                                                        <div class="ot-filter-tab"
                                                                            data-filter="shipping"
                                                                            onclick="filterOrders(this,'shipping')">
                                                                            <span
                                                                                class="material-symbols-outlined">local_shipping</span>
                                                                            Đang giao
                                                                        </div>
                                                                        <div class="ot-filter-tab"
                                                                            data-filter="completed"
                                                                            onclick="filterOrders(this,'completed')">
                                                                            <span
                                                                                class="material-symbols-outlined">check_circle</span>
                                                                            Hoàn thành
                                                                        </div>
                                                                        <div class="ot-filter-tab"
                                                                            ...
                                                                            onclick="filterOrders(this,'cancelled')">
                                                                            <span
                                                                    ...
                                                                    <%-- No Orders --%>
                                                                        <c:if test="${empty orders}">
                                                                            <div class="ot-empty visible">
                                                                                ...
                                                                                <p>Bạn chưa đặt hàng online. Hãy khám
                                                                                    phá thực đơn của chúng tôi!</p>
                                                                                <a href="${pageContext.request.contextPath}/category"
                                                                                    class="ot-empty-btn">
                                                                                    <span
                                                                                        class="material-symbols-outlined">storefront</span>
                                                                                    Khám phá thực đơn
                                                                                </a>
                                                                            </div>
                                                                        </c:if>
                                                                            ...
                                                                            <c:if test="${not empty orders}">
                                                                                <div class="ot-order-list"
                                                                                    ...
                                                                                    <c:forEach var="orderInfo"
                                                                                        items="${orders}">
                                                                                        <c:set var="order"
                                                                                            value="${orderInfo.order}" />
                                                                                        <c:set var="details"
                                                                                            value="${orderInfo.details}" />
                                                                                        <c:set var="address"
                                                                                            value="${orderInfo.address}" />

                                                                                        <c:set var="placedTime"
                                                                                            value="" />
                                                                                        <c:set var="confirmedTime"
                                                                                            value="" />
                                                                                        <c:set var="deliveringTime"
                                                                                            value="" />
                                                                                        <c:set var="completedTime"
                                                                                            value="" />

                                                                                        <c:if
                                                                                            test="${not empty order.createdAt}">
                                                                                            <c:set var="dtStr"
                                                                                                value="${order.createdAt.toString()}" />
                                                                                            <c:set var="placedTime"
                                                                                                value="${fn:substring(dtStr, 11, 16)} ${fn:substring(dtStr, 8, 10)}/${fn:substring(dtStr, 5, 7)}" />
                                                                                        </c:if>

                                                                                        <c:forEach var="log"
                                                                                            items="${orderInfo.deliveryLogs}">
                                                                                            <c:choose>
                                                                                                <c:when
                                                                                                    test="${log.status == 'ShipperConfirmed' && not empty log.shipperConfirmedAt}">
                                                                                                    <c:set var="cfStr"
                                                                                                        value="${log.shipperConfirmedAt.toString()}" />
                                                                                                    <c:set
                                                                                                        var="confirmedTime"
                                                                                                        value="${fn:substring(cfStr, 11, 16)} ${fn:substring(cfStr, 8, 10)}/${fn:substring(cfStr, 5, 7)}" />
                                                                                                </c:when>
                                                                                                <c:when
                                                                                                    test="${log.status == 'Delivering' && not empty log.pickedUpAt}">
                                                                                                    <c:set var="puStr"
                                                                                                        value="${log.pickedUpAt.toString()}" />
                                                                                                    <c:set
                                                                                                        var="deliveringTime"
                                                                                                        value="${fn:substring(puStr, 11, 16)} ${fn:substring(puStr, 8, 10)}/${fn:substring(puStr, 5, 7)}" />
                                                                                                </c:when>
                                                                                                <c:when
                                                                                                    test="${(log.status == 'Delivered' || log.status == 'Completed') && not empty log.deliveredAt}">
                                                                                                    <c:set var="dvStr"
                                                                                                        value="${log.deliveredAt.toString()}" />
                                                                                                    <c:set
                                                                                                        var="completedTime"
                                                                                                        value="${fn:substring(dvStr, 11, 16)} ${fn:substring(dvStr, 8, 10)}/${fn:substring(dvStr, 5, 7)}" />
                                                                                                </c:when>
                                                                                                <c:when
                                                                                                    test="${(log.status == 'Delivered' || log.status == 'Completed') && not empty log.customerConfirmedAt}">
                                                                                                    <c:set var="dvStr"
                                                                                                        value="${log.customerConfirmedAt.toString()}" />
                                                                                                    <c:set
                                                                                                        var="completedTime"
                                                                                                        value="${fn:substring(dvStr, 11, 16)} ${fn:substring(dvStr, 8, 10)}/${fn:substring(dvStr, 5, 7)}" />
                                                                                                </c:when>
                                                                                        ...
                                                                                        <%-- Map status → CSS class --%>
                                                                                            ...
                                                                                            <c:choose>
                                                                                                ...
                                                                                                <c:when
                                                                                                    test="${order.orderStatus == 'Preparing'}">
                                                                                                    <c:set var="sc"
                                                                                                        value="preparing" />
                                                                                                </c:when>
                                                                                                <c:when
                                                                                                    test="${order.orderStatus == 'In_Progress'}">
                                                                                                    <c:set var="sc"
                                                                                                        value="preparing" />
                                                                                                </c:when>
                                                                                                <c:when
                                                                                                    test="${order.orderStatus == 'Ready' || order.orderStatus == 'Waiting_Shipper'}">
                                                                                                    <c:set var="sc"
                                                                                                        value="preparing" />
                                                                                                </c:when>
                                                                                                <c:when
                                                                                                    test="${order.orderStatus == 'Delivering'}">
                                                                                                    <c:set var="sc"
                                                                                                        value="shipping" />
                                                                                                </c:when>
                                                                                                <c:when
                                                                                            ...
                                                                                            <%-- Status label --%>
                                                                                                ...
                                                                                                <%-- Status icon --%>
                                                                                                    ...
                                                                                                    <c:choose>
                                                                                                        ...
                                                                                                        <c:when
                                                                                                            test="${order.orderStatus == 'Preparing' || order.orderStatus == 'In_Progress'}">
                                                                                                            <c:set
                                                                                                                var="si"
                                                                                                                value="coffee_maker" />
                                                                                                        </c:when>
                                                                                                    ...
                                                                                                    <div class="ot-order-card"
                                                                                                        ...
                                                                                                        <%-- Card Header
                                                                                                            --%>
                                                                                                            <div
                                                                                                                class="ot-card-header">
                                                                                                                <div
                                                                                                                    class="ot-card-header-left">
                                                                                                                    <div
                                                                                                                        class="ot-order-icon">
                                                                                                                        <span
                                                                                                                            class="material-symbols-outlined">${si}</span>
                                                                                                                    </div>
                                                                                                                    <div
                                                                                                                        class="ot-order-meta">
                                                                                                                        <h3>#BH-${order.orderId}
                                                                                                                        ...
                                                                                                                        <div
                                                                                                                            ...
                                                                                                                            <c:if
                                                                                                                                test="${not empty order.createdAt}">
                                                                                                                                ${fn:substring(order.createdAt.toString(),
                                                                                                                                0,
                                                                                                                                16)}
                                                                                                                            </c:if>
                                                                                                                        </div>
                                                                                                                ...
                                                                                                                <div
                                                                                                                    class="ot-card-header-right">
                                                                                                                    <span
                                                                                                                        class="ot-badge ot-badge-${sc}">
                                                                                                                        <span
                                                                                                                            class="material-symbols-outlined">${si}</span>
                                                                                                                        ${sl}
                                                                                                                    </span>
                                                                                                                    <c:choose>
                                                                                                                        ...
                                                                                                                        <c:otherwise>
                                                                                                                            <span
                                                                                                                                class="ot-badge ot-badge-unpaid">
                                                                                                                                <span
                                                                                                                            ...
                                                                                                                            <%-- Step
                                                                                                                                ...
                                                                                                                                <div
                                                                                                                                    ...
                                                                                                                                    <div
                                                                                                                                        class="ot-tl-dot">
                                                                                                                                        <span
                                                                                                                                            class="material-symbols-outlined">receipt</span>
                                                                                                                                    </div>
                                                                                                                                    <div
                                                                                                                                        class="ot-tl-label">
                                                                                                                                        Đặt
                                                                                                                                ...
                                                                                                                                <%-- Step
                                                                                                                                    ...
                                                                                                                                    <c:choose>
                                                                                                                                        ...
                                                                                                                                        <c:when
                                                                                                                                            test="${order.orderStatus == 'Ready' || order.orderStatus == 'Waiting_Shipper' || order.orderStatus == 'Delivering' || order.orderStatus == 'Completed'}">
                                                                                                                                            <c:set
                                                                                                                                                var="s2"
                                                                                                                                                value="done" />
                                                                                                                                        </c:when>
                                                                                                                                    ...
                                                                                                                                    <%-- Step
                                                                                                                                        ...
                                                                                                                                        <c:choose>
                                                                                                                                            <c:when
                                                                                                                                                test="${order.orderStatus == 'Ready' || order.orderStatus == 'Waiting_Shipper' || order.orderStatus == 'Delivering'}">
                                                                                                                                                <c:set
                                                                                                                                                    var="s3"
                                                                                                                                                    value="active" />
                                                                                                                                            </c:when>
                                                                                                                                        ...
                                                                                                                                        <%-- Step
                                                                                                                                            ...
                                                                                                                                            <div
                                                                                                                                                ...
                                                                                                                                                <div
                                                                                                                                                    class="ot-tl-dot">
                                                                                                                                                    <span
                                                                                                                                                        class="material-symbols-outlined">task_alt</span>
                                                                                                                                                </div>
                                                                                                                                                <div
                                                                                                                                                    class="ot-tl-label">
                                                                                                                                                    Hoàn
                                                                                                                    ...
                                                                                                                    <%-- Toggle
                                                                                                                        ...
                                                                                                                        <c:if
                                                                                                                            ...
                                                                                                                            <div class="ot-collapsible"
                                                                                                                                id="detail-${order.orderId}">
                                                                                                                                <div
                                                                                                                                    class="ot-card-divider">
                                                                                                                                </div>
                                                                                                                                <div
                                                                                                                                    class="ot-card-items">
                                                                                                                                    <c:forEach
                                                                                                                                        ...
                                                                                                                                        <div
                                                                                                                                            ...
                                                                                                                                            <div
                                                                                                                                                class="ot-item-left">
                                                                                                                                                <span
                                                                                                                                                    class="ot-item-qty-badge">x${item.quantity}</span>
                                                                                                                                                <div>
                                                                                                                                                    <div
                                                                                                                                                        class="ot-item-name">
                                                                                                                                                        ${item.productName}
                                                                                                                        ...
                                                                                                                        <%-- Card
                                                                                                                            ...
                                                                                                                            <div
                                                                                                                                class="ot-card-footer">
                                                                                                                                <div
                                                                                                                                    class="ot-card-footer-left">
                                                                                                                                    <div
                                                                                                                                        class="ot-payment-info">
                                                                                                                                        <span
                                                                                                                                    ...
                                                                                                                                    <c:if
                                                                                                                                        ...
                                                                                                                                        <div
                                                                                                                                            class="ot-delivery-info">
                                                                                                                                            <span
                                                                                                                                                class="material-symbols-outlined">location_on</span>
                                                                                                                                            <span>${address.recipientName}
                                                                                                                                                ·
                                                                                                                                ...
                                                                                                                                <div
                                                                                                                                    class="ot-footer-right-block">
                                                                                                                                    <div
                                                                                                                                        class="ot-total-block">
                                                                                                                                        <div
                                                                                                                                            class="ot-total-label">
                                                                                                                                            Thành
                                                                                                                                            tiền
                                                                                                                                        </div>
                                                                                                                                        <div
                                                                                                                                            class="ot-total-amount">
                                                                                                                                            <fmt:formatNumber
                                                                                                                                                value="${order.finalAmount != null ? order.finalAmount : order.totalAmount}"
                                                                                                                                                pattern="#,###" />
                                                                                                                                            ₫
                                                                                                                                        </div>
                                                                                                                                        <c:if
                                                                                                                                    ...
                                                                                                                                    <%-- Nút
                                                                                                                                        ...
                                                                                                                                        --%>
                                                                                                                                        <c:if
                                                                                                                                            test="${order.orderStatus == 'Pending' || order.orderStatus == 'Preparing' || order.orderStatus == 'In_Progress'}">
                                                                                                                                            <form
                                                                                                                                                method="post"
                                                                                                                                        ...
                                                                                                                                        <%-- Nút
                                                                                                                                            ...
                                                                                                                                            <c:if
                                                                                                                                                ...
                                                                                                                                                <c:choose>
                                                                                                                                                    <c:when
                                                                                                                                                        test="${fn:contains(reviewedOrderIds, reviewKey)}">
                                                                                                                                                        <div
                                                                                                                                                            class="ot-reviewed-badge">
                                                                                                                                                            <span
                                                                                    ...
                                                                                    <%-- Empty state for filter --%>
                                                                                        <div class="ot-empty"
                                                                                            id="filterEmpty">
                                                                                            <span
                                                                                                class="material-symbols-outlined">filter_list_off</span>
                                                                                            <h3>Không có đơn hàng</h3>
                                                                                            <p>Không tìm thấy đơn hàng ở
                                                                                                trạng thái này.</p>
                                                                                        </div>
                                                                            </c:if>
                                    ...
                                    <%-- ── Review Modal ── --%>
                                        <div class="ot-review-overlay" id="reviewOverlay"
                                            onclick="closeReviewModal(event)" style="display:none;">
                                            <div class="ot-review-modal">
                                                <button class="ot-review-close" onclick="closeReviewModal(null)"
                                                    aria-label="Đóng">
                                                    <span class="material-symbols-outlined">close</span>
                                                </button>
                                                <div class="ot-review-header">
                                                    <span
                                                        class="material-symbols-outlined ot-review-header-icon">star_rate</span>
                                                ...
                                                <textarea class="ot-review-comment" id="reviewComment" rows="3"
                                                    maxlength="500"
                                                    placeholder="Nhận xét của bạn (tuỳ chọn)..."></textarea>
                                                <div class="ot-review-msg" id="reviewMsg"></div>
                                                <div class="ot-review-actions">
                                                    <button class="ot-review-cancel"
                                                        onclick="closeReviewModal(null)">Hủy</button>
                                                    <button class="ot-review-submit" id="btnSubmitReview"
