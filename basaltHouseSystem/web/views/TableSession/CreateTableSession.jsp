                    ...
                    <%@page import="model.TableSession" %>
                        ...
                        <head>
                            ...
                            <link
                                ...
                                rel="stylesheet">
                            <link
                                href="${pageContext.request.contextPath}/css/TableSessionCss/TableSession.css?v=<%=System.currentTimeMillis()%>"
                                rel="stylesheet">
                        </head>
                                                                        ...
                                                                        <div class="row g-4">
                                                                            ...
                                                                            <div class="col-lg-8">
                                                                                <div class="tables-panel">
                                                                                    <div class="panel-label">Sơ đồ bàn
                                                                                    </div>
                                                                                    <div class="panel-title">Chọn Bàn
                                                                                    </div>
