            ...
            <%@ taglib prefix="fn" uri="jakarta.tags.functions" %>
                ...
                <head>
                    ...
                    <link rel="stylesheet" type="text/css"
                        href="${pageContext.request.contextPath}/css/shipper/shipper.css">
                </head>
                ...
                <body>
                    ...
                    <%-- ══════════════════════════════════════════════════════════════ HEADER
                            ...
                            <div class="s-header__left">
                                <c:choose>
                                    <c:when test="${not empty currentShipper.avatarUrl}">
                                        <img src="${fn:escapeXml(currentShipper.avatarUrl)}" alt="avatar"
                                            class="s-avatar">
                                    </c:when>
                                    <c:otherwise>
                                ...
                                <div>
                                    <div class="s-header__name">
                                        <c:out value="${currentShipper.fullName}" />
                                    </div>
                        ...
                        <%-- ══════════════════════════════════════════════════════════════ FLASH MESSAGE (đọc từ
                            Session, xóa ngay sau khi hiển thị)
                            ══════════════════════════════════════════════════════════════ --%>
                                    ...
                                    <c:choose>
                                        <c:when test="${sessionScope.flashSuccess == true}">
                                            <div class="alert alert-success flash-alert" role="alert">
                                                ...
                                                <button type="button" class="btn-close ms-auto p-0"
                                                    data-bs-dismiss="alert" style="font-size:.8rem"></button>
                                            </div>
                                        </c:when>
                                        <c:otherwise>
                                ...
                                <%-- ══════════════════════════════════════════════════════════════ PANEL 1 – ĐƠN CHỜ
                                                    ...
                                                    <div class="o-card">
                                                        <%-- Dòng meta: mã đơn + giờ tạo --%>
                                                            <div class="o-card__meta">
                                                                ...
                                                                <%-- LocalDateTime.toString() → "2024-06-18T14:30:00" →
                                                                    cắt lấy phần giờ --%>
                                                                    <span class="o-card__time">
                                                                        ${fn:substring(order.createdAt.toString(), 11,
                                                                        16)}
                                                                        &nbsp;${fn:substring(order.createdAt.toString(),
                                                                        8,
                                                                        10)}/${fn:substring(order.createdAt.toString(),
                                                                        5, 7)}
                                                                    </span>
                                                            </div>
                                                            ...
                                                            <%-- Tên khách --%>
                                                                ...
                                                                <%-- Số tiền + phương thức --%>
                                                                    <div class="o-card__bottom">
                                                                        <div>
                                                                            <div class="o-card__amount-label">Cần thu
                                                                            </div>
                                    ...
                                    <%-- ══════════════════════════════════════════════════════════════ PANEL 2 – ĐƠN
                                        ...
                                        <div class="panel" id="panel-2">
                                                    ...
                                                    <%-- ── Thẻ thông tin đơn hàng ────────────────────── --%>
                                                        <div class="cur-card">
                                                            <div class="cur-card__head">
                                                                <div class="cur-card__head-top">
                                                                    <span class="cur-id-badge">
                                                                        <i
                                                                            class="bi bi-hash"></i>Đơn&nbsp;${currentOrder.orderId}
                                                                    </span>
                                                                ...
                                                                <div class="cur-card__amount">
                                                                    <fmt:formatNumber
                                                                        value="${currentOrder.finalAmount}"
                                                            ...
                                                            <div class="cur-card__body">
                                                                <div class="info-section-title">Thông tin giao hàng
                                                                </div>
                                                                    ...
                                                                    <c:when test="${not empty deliveryAddress}">
                                                                        ...
                                                                        <%-- Người nhận --%>
                                                                            <div class="info-row">
                                                                                ...
                                                                                <div>
                                                                                    <div class="info-label">Người nhận
                                                                                    </div>
                                                                                    <div class="info-val">
                                                                                        <c:out
                                                                            ...
                                                                            <%-- Điện thoại + nút gọi nhanh --%>
                                                                                <div class="info-row">
                                                                                    ...
                                                                                    <div>
                                                                                        <div class="info-label">Điện
                                                                                            thoại</div>
                                                                                        <div class="info-val"
                                                                                            style="display:flex;align-items:center;flex-wrap:wrap;gap:4px">
                                                                                            <c:out
                                                                                                value="${deliveryAddress.recipientPhone}" />
                                                                                            <a href="tel:${deliveryAddress.recipientPhone}"
                                                                                                class="btn-call">
                                                                                                <i
                                                                                                    class="bi bi-telephone-fill"></i>Gọi
                                                                                                ngay
                                                                                            </a>
                                                                                        </div>
                                                                                    </div>
                                                                                ...
                                                                                <%-- Địa chỉ --%>
                                                                                    ...
                                                                                    <%-- Ghi chú (nếu có) --%>
                                                                                        <c:if
                                                                                            test="${not empty deliveryAddress.note}">
                                                                                            <div class="info-row">
                                                                                                <div class="info-icon">
                                                                                                    <i
                                                                                                        class="bi bi-sticky-fill"></i>
                                                                                                </div>
                                                                                                <div>
                                                                                                    <div
                                                                                                        class="info-label">
                                                            ...
                                                            <div class="act-card">
                                                                ...
                                                                <%-- POST tới UpdateDeliveryServlet, action=success --%>
                                                                    <form method="post"
                                                                        ...
                                                                        <div class="mb-3">
                                                                            <label class="lbl">
                                                                                <i class="bi bi-image me-1"></i>Link ảnh
                                                                                bằng chứng giao hàng
                                                                            </label>
                                                                            <input type="url" name="proofImageUrl"
                                                                                class="inp"
                                                                        ...
                                                                        <div class="mb-3">
                                                                            <label class="lbl">
                                                                                <i class="bi bi-chat-text me-1"></i>Ghi
                                                                                chú (tùy chọn)
                                                                            </label>
                                            ...
                                            <%-- ══════════════════════════════════════════════════════════════ MODAL –
                                                CHỌN LÝ DO THẤT BẠI (chỉ render khi có đơn đang giao để tránh lỗi EL
                                                null) ══════════════════════════════════════════════════════════════
                                                --%>
                                                <c:if test="${not empty currentOrder}">
                                                            ...
                                                            <div class="modal-content"
                                                                ...
                                                                <div class="modal-header border-0"
                                                                    ...
                                                                    <h5 class="modal-title fw-bold" id="failModalLbl">
                                                                        <i
                                                                            class="bi bi-exclamation-triangle-fill me-2"></i>Báo
                                                                        giao thất bại
                                                                    </h5>
                                                                    <button type="button"
                                                                ...
                                                                <%-- POST tới UpdateDeliveryServlet, action=failed --%>
                                                                    <form method="post"
                                                                        ...
                                                                        <%-- Input ẩn chứa lý do thực sự sẽ gửi đi --%>
                                                                            <input type="hidden" name="failReason"
                                                                                id="finalReason">

                                                                            <div class="modal-body p-3">
                                                                                <p class="small text-muted mb-3">
                                                                                    Chọn hoặc nhập lý do không giao
                                                                                    được:
                                                                                </p>

                                                                                <label class="reason-opt">
                                                                                    <input type="radio" name="reasonChoice" value="Khách không nghe máy, không ra nhận hàng">
                                                                                    <span>📵&nbsp;Khách không nghe máy, không ra nhận hàng</span>
                                                                                </label>
                                                                                <label class="reason-opt">
                                                                                    <input type="radio" name="reasonChoice" value="Địa chỉ không tìm thấy hoặc không chính xác">
                                                                                    <span>📍&nbsp;Địa chỉ không tìm thấy hoặc không chính xác</span>
                                                                                </label>
                                                                                <label class="reason-opt">
                                                                                    <input type="radio" name="reasonChoice" value="Khách hủy đơn khi đang giao">
                                                                                    <span>❌&nbsp;Khách hủy đơn khi đang giao</span>
                                                                                </label>
                                                                                <label class="reason-opt">
                                                                                    <input type="radio" name="reasonChoice" value="Sự cố xe, không thể tiếp tục giao">
                                                                                    <span>🔧&nbsp;Sự cố xe, không thể tiếp tục giao</span>
                                                                                </label>


                                                                                <div class="mt-3">
                                                                                    <label class="lbl">Hoặc nhập lý do
                                                                                        khác:</label>
                                                                            ...
                                                                            <div
                                                                                class="modal-footer border-0 pt-0 gap-2">
                                                                                <button type="button"
                                                                                ...
                                                                                <button type="submit"
                                                                                    ...
                                                                                    id="btnConfirmFail">
                                                                                    <span class="spin spin-red"
                                                                                        id="spinFail"></span>
                                                                                    <i class="bi bi-send me-1"></i>Xác
                                                                                    nhận thất bại
                                                                                </button>
                                                                            </div>
                                                                    </form>
