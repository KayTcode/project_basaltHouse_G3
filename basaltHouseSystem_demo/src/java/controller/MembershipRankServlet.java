...
public class MembershipRankServlet extends HttpServlet {
    ...
    private static final CustomerMemberShipService CService = new CustomerMemberShipService();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet MembershipRankServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet MembershipRankServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        HashMap<String, Object> s = CService.getCustomeRankingById(user.getAccountId());
        ...
        HashMap<String, Object> s2 = CService.getRankName();
        if (s2.containsKey("error")) {
            request.setAttribute("error", s.get("error").toString());
        } else {
            list = (List<MembershipRank>) s.get("success");
        }
